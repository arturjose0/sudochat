...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (isset($_POST['id']) && ctype_digit($_POST['id'])) {
        ...
        $stmt = $pdo->prepare("SELECT " . USER_ATTB_ID . " as USER_ATTB_ID, " . USER_ATTB_NOME . " as USER_ATTB_NOME FROM " . TB_UTILIZADORES . " where " . USER_ATTB_ID . "=" . ID);
        $stmt->execute();
...
<div class="conteudos">
  ...
  <form action="vendor/JoseArturKassala.php" method="POST" id="chatForm">
...
HTML;
        ...
        echo "MENSAGEM NAO ENCONTRADA";
    }
} else {
    echo "SOLICITACAO NEGADA";
}
