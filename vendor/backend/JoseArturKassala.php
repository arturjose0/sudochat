...
define("MENSAGENS_ATTB_APAGADA", getenv("MENSAGENS_ATTB_APAGADA"));
define("MENSAGENS_ATTB_APAGADA_POR", getenv("MENSAGENS_ATTB_APAGADA_POR"));
define("MENSAGENS_ATTB_APAGADA_EM", getenv("MENSAGENS_ATTB_APAGADA_EM"));
...
define("MENSAGENS_USER_GRUPO_ATTB_APAGADA", getenv("MENSAGENS_USER_GRUPO_ATTB_APAGADA"));
define("MENSAGENS_USER_GRUPO_ATTB_APAGADA_POR", getenv("MENSAGENS_USER_GRUPO_ATTB_APAGADA_POR"));
define("MENSAGENS_USER_GRUPO_ATTB_APAGADA_EM", getenv("MENSAGENS_USER_GRUPO_ATTB_APAGADA_EM"));
...
$sql = "CREATE TABLE IF NOT EXISTS " . TB_MENSAGENS . " (
    ...
    " . MENSAGENS_ATTB_APAGADA . " int(1) NOT NULL DEFAULT 0,
    " . MENSAGENS_ATTB_APAGADA_POR  . " bigint UNSIGNED,
    " . MENSAGENS_ATTB_APAGADA_EM . " TIMESTAMP DEFAULT NULL,
...
$sqlMensagemGrupo = "CREATE TABLE IF NOT EXISTS " . TB_MENSAGENS_USER_GRUPO . " (
    ...
    " . MENSAGENS_USER_GRUPO_ATTB_APAGADA . " int(1) NOT NULL DEFAULT 0,
    " . MENSAGENS_USER_GRUPO_ATTB_APAGADA_POR . " bigint UNSIGNED,
    " . MENSAGENS_USER_GRUPO_ATTB_APAGADA_EM . " TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
